...
import type { CertificationKind, SkillKind } from "../types";
...
const resolvesInBothLanguages = (key: TranslationKey): boolean => {
  const entry = translations[key] as TranslationEntry;
  return (
    !!entry &&
...
describe("techSkills", () => {
  const KINDS: SkillKind[] = ["Frontend", "Backend", "Database", "AI", "Other"];
...
describe("certifications", () => {
  const CATEGORIES: CertificationKind[] = [
    "Award",
    "Certificate",
    "Course",
