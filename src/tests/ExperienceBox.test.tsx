...
// Only `period` is asserted below; title/location/company must still be real
// translation keys since ExperienceBox's prop type requires TranslationKey.
const baseItem: Experience = {
